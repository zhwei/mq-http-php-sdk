...
namespace AliyunMQ\Http;

use GuzzleHttp\Exception\TransferException;
use GuzzleHttp\Psr7\Request;
use AliyunMQ\AsyncCallback;
use AliyunMQ\Config;
use AliyunMQ\Constants;
use AliyunMQ\Exception\MQException;
use AliyunMQ\Requests\BaseRequest;
use AliyunMQ\Responses\BaseResponse;
use AliyunMQ\Responses\MQPromise;
use AliyunMQ\Signature\Signature;
